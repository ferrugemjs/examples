define(["exports", "incremental-dom", "ferrugemjs", "./fruit-item"], function(exports, _idom, _libfjs_mod_, _fruit_item) {
    ...
    exports.default = (function(super_clazz) {
        function _clazz_sub_1487649377108_tmp() {
            super_clazz.call(this);
        }
        _clazz_sub_1487649377108_tmp.prototype = Object.create(super_clazz.prototype);
        _clazz_sub_1487649377108_tmp.prototype.constructor = _clazz_sub_1487649377108_tmp;
        _clazz_sub_1487649377108_tmp.prototype._$attrs$_ = {
            "name": "div",
            "static": ["class", "fruit-item"],
            "dinamic": "\"\""
        };
        _clazz_sub_1487649377108_tmp.prototype.render = function($_this_$) {
            _idom.elementOpen("div", null, [""], "class", ('fruit type_' + ($_this_$.type)));
            _idom.elementClose("div");
        }
        return _clazz_sub_1487649377108_tmp;
