define(["exports", "incremental-dom", "ferrugemjs", "./todo-item"], function(exports, _idom, _libfjs_mod_, _todo_item) {
    ...
    exports.default = (function(super_clazz) {
        function _clazz_sub_1488079046647_tmp() {
            super_clazz.call(this);
        }
        _clazz_sub_1488079046647_tmp.prototype = Object.create(super_clazz.prototype);
        _clazz_sub_1488079046647_tmp.prototype.constructor = _clazz_sub_1488079046647_tmp;
        _clazz_sub_1488079046647_tmp.prototype._$attrs$_ = {
            "name": "div",
            "static": ["class", "todo-item"],
            "dinamic": "\"\""
        };
        _clazz_sub_1488079046647_tmp.prototype.render = function($_this_$) {
        ...
        return _clazz_sub_1488079046647_tmp;
